...
```{r}
writefGSEAResults(gsea_results_pbmc, output_name = 'PBMC_GSEA.xlsx', outdir = here('outputs/PBMC'))
writefGSEAResults(gsea_results_rb, output_name = 'RB_GSEA.xlsx', outdir = here('outputs/RB'))
```
